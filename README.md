...
[![My Skills](https://skillicons.dev/icons?i=java,spring,postgres,cs,dotnet,angular,nodejs,html,css,js,ts,ruby,rails,mysql,mongodb,docker,rabbitmq,redis,git,postman&theme=dark)](https://skillicons.dev)
